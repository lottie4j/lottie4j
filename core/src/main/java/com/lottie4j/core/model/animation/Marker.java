 ...
 *
 * @param time     the temporal position of the marker in the animation timeline, measured in seconds
 * @param comment  an optional descriptive label or identifier for the marker
 * @param duration an optional duration in seconds, defining a time range when the marker represents
